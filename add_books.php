<?php include('add_booksfunction.php') ?>
...
<h2>Admin - ADD BOOKS</h2>

</div>


<form method="POST" action="add_booksfunction.php" enctype="multipart/form-data">
...
<div class="input-group">
  ...
  <select name="book_type" id="user_type" >
    <option value=""></option>
    <option value="admin">new</option>
    <option value="user">old</option>
  </select>
</div>
<div class="input-group">
<label>PRICE</label>
