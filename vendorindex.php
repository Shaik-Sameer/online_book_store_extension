			...
			<div>
				<?php  if (isset($_SESSION['user'])) : ?>
					...
					<small>
						...
						<br>
						&nbsp; <a href="add_newbook.php"> ADD BOOKS</a> <br>
						&nbsp; <a href="remove_newbooks.php"> REMOVE BOOKS</a> <br>
						<a href="vendorlogout.php" style="color: red;">logout</a>
					</small>
